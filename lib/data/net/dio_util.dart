...
class Io {
  ...
  /// 文件上传
  static updateFile(String url, File file,
      {String size, Function monitor}) async {
    ...
    Dio dio = Dio();
    Response respone =
        await dio.post(baseUrl + url, data: formData, onSendProgress: monitor);
  ...
  static _base(
    ...
    try {
      switch (option.method) {
        ...
        case 'get':
          response =
              await dio.request(url, queryParameters: data, options: option);
          break;
        case 'POST':
        case 'post':
